...
func bizListSearchItems(name string, itemDescription string, searchLogic string) ([]string, error) {
	// dont change func declaration.
	// global list..
	// serchLogin --> and / or; alfred to decide.
	// []string
	//func bizListSearchItems(items arrds.Items, search string, searchLogic string) (arrds.Items, error) {
